...
import { aiRouter, monitorRouter, aiHealthRouter, ragRouter, llmProviderRouter, collaborationRouter, promptsRouter, agentWorkflowRouter, documentRouter, agentWorkflowWebhookRouter, agentWorkflowOpenRouter } from './ai/index.js'
...
app.use(agentWorkflowOpenRouter.routes())
app.use(agentWorkflowOpenRouter.allowedMethods())
